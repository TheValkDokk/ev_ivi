...
import com.evn.ev_ivi.features.map.data.repositories.LocationRepositoryImpl
...
val mapPanelModules = module {
    ...
    viewModel { MapPanelViewModel(get()) }
    ...
    single<LocationRepository> {
        LocationRepositoryImpl(androidContext(), get<FusedLocationProviderClient>())
    }
    factory { GetLocationUpdatesUseCase(get<LocationRepository>()) }
